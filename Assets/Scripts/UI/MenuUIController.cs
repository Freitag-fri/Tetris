...
{
    public class MenuUIController : MonoBehaviour, IMovable
    {
        ...
        private MenuStatus statusBeforeSettings;
        ...
        {
            if (currentMenuStatus != MenuStatus.Settings)
                OpenSettings();
            else
                CloseSettings();
        }
        ...
        {
            statusBeforeSettings = currentMenuStatus;
            currentMenuStatus = MenuStatus.Settings;
        ...
        private void CloseSettings()
        {
            //mb save some data
            settingsPanel.SetActive(false);
            currentMenuStatus = statusBeforeSettings;
            touchInputController.enabled = currentMenuStatus == MenuStatus.BoardSkins
        ...
        public void Move(MoveDirection direction)
        {
            switch (direction)
            {
                ...
                case MoveDirection.TurnRight:
                    ...
                    break;
                default:
                    Debug.Log($"Move direction {direction} is not supported in MenuUIController");
                    break;
            }
        }
    }
